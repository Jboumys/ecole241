...
class PieceIdentification
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\Requerant", inversedBy="pieceIdentification", cascade={"persist", "remove"})
     * @ORM\JoinColumn(nullable=false)
     */
    private $requerant;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\TypePiece", inversedBy="pieceIdentifications")
     * @ORM\JoinColumn(nullable=false)
     */
    private $typePiece;
     ...
     *
     * @Vich\UploadableField(mapping="identify_images", fileNameProperty="imageName", size="imageSize")
     *
     * @var File
     */
    private $imageFile;
